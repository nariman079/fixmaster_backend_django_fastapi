# Generated by Django 4.2.6 on 2024-05-17 07:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('new', 'Новый'), ('in-progress', 'В прогрессе'), ('done', 'Закончено')], default='new', max_length=20, null=True, verbose_name='Статус')),
                ...
                ('customer_notice', models.CharField(max_length=120, verbose_name='Коментарий')),
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='src.customer', verbose_name='Клиент')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_end_time', models.TimeField(blank=True, editable=False, null=True, verbose_name='Длительность процедуры')),
